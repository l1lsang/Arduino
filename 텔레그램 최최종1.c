...
String token = "7229635765:AAEyRkFTR4ZrwS1XOOphRK2jRNmu6mQetlo"; // Telegram Bot Token
...
const long interval = 180000; // 10 minutes
...
void loop() {
  unsigned long currentMillis = millis();
    delay(1000);
    myBot.sendMessage(chat_id, "토양습도: " + String(v1));
